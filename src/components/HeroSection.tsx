      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full text-center">
        ...
        <ScrollReveal delay={0}>
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 border border-synapse-cyan/30 rounded-full bg-secondary/30">
            ...
            <span className="text-sm text-muted-foreground">Ativo 24 horas por dia, 7 dias por semana</span>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={200}>
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            Agentes de IA que <span className="text-synapse-cyan">prospectam</span>, 
            <span className="text-synapse-cyan"> qualificam</span> e 
            <span className="text-synapse-cyan"> agendam reuniões</span> automaticamente — 
        ...
        <ScrollReveal delay={400}>
          <div className="grid sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="flex items-center justify-center gap-3 p-4 bg-secondary/30 border border-border rounded-lg">
              ...
              <span className="text-sm text-muted-foreground">Resposta em segundos</span>
            </div>
            <div className="flex items-center justify-center gap-3 p-4 bg-secondary/30 border border-border rounded-lg">
              <Zap className="w-5 h-5 text-synapse-cyan" />
              <span className="text-sm text-muted-foreground">100% dos leads atendidos</span>
            </div>
            <div className="flex items-center justify-center gap-3 p-4 bg-secondary/30 border border-border rounded-lg">
              <TrendingUp className="w-5 h-5 text-synapse-cyan" />
              <span className="text-sm text-muted-foreground">3x mais conversões</span>
            </div>
          </div>
        </ScrollReveal>
      </div>
